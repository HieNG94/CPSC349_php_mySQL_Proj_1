...
<script type="text/javascript">
    $value = "";
    var addCard = function(name, vID, pID, date, time, staff, note) {
        var myPanel = $(`
...
$sql = "SELECT * FROM visitView WHERE personID = '$personID';";
$result = mysqli_query($conn, $sql);
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $staff = $row['staff'];
    $note = $row['note'];
    echo "<script> addCard('$petName','$vID', '$petID','$date', '$time', '$staff', '$note'); </script>";
}
